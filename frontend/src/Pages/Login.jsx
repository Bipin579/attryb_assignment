...
function Login() {
  ...
  const handleSubmit = (event) => {
    ...
    if (email && password && password === confirmPassword) {
      ...
      dispatch(login(user, newToastSucess, newToastFail, navigateUser));
    } else {
      return toast({
    ...
    >
      ...
      >
        ...
        <Box mt={10}>
          ...
          <Text color="white">Dont have an account ? <Text color={"orange.800"} as={"span"}><Link to="/signup">Register</Link></Text></Text>
